...
const DashboardSection = () => {
  ...
  const [title, setTitle] = useState("Gold / BTC");
  const [seletedStockTicker, setSeletedStockTicker] = useState("GLD");
            ...
            {sortedTableData &&
              sortedTableData.map((item, idx) => (
                ...
                >
                  ...
                  <td className={`px-0 py-4 ${(getNameBySymbol(item.symbol) == "Gold" || getNameBySymbol(item.symbol) == "Natural Gas" || getNameBySymbol(item.symbol) == "COFFEE")  ? "" : ""}`}>
